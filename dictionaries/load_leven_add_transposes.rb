...
def load_leven_add_transposes
  ...
  @log_file.puts Benchmark.measure{
    @popular_and_in_sowpods.each{|word|
      ...
      REDIS.incr 'levenhood_add_transposes'
    } 
	}	
  @log_file.close
end