...
Anagrams:   
  ...
  Add word to anagrams using Ruby
    require 'curb'
    host = "www.jimrails.com/anagrams.json"
...
Read words from a dictionary with paging

curl $HOST'/words.json?dictionary=sowpods&start=15000'
