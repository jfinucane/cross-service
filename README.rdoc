...
Words: 
  ...
  Up to 300 words returned at a time;  to override:   &page_size=1000

  Services                                            returns
    curl anagrams.$HOST/sample.json                   list
    curl startswith.$HOST/sample.json                 list
    curl contains.$HOST/demo.json                     list
    curl suggestions.$HOST/demo.json                  lists in hash, by length @wip
    curl autocomplete.$HOST/demo.json                 list @wip
